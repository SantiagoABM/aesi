            ...
            <dl className="mt-6 space-y-4">
...

              {
                    ...
                    coupon !== undefined ? (
                        ...
                        >
                            Cupón: {coupon.name} está aplicado.
                        </div>
                    ) : (
                        <Fragment></Fragment>
                    )
              ...
              <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                ...
                <dd className="text-sm font-medium text-gray-900">{shipping && shipping_id !== 0 ? <>S/.{shipping_cost}</>:<div className="text-red-500">(Please select shipping option)</div>}</dd>
              </div>
              ...
              <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                ...
                <dd className="text-sm font-medium text-gray-900">S/.{estimated_tax}</dd>
              </div>
              ...
              <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                ...
                <dd className="text-sm font-medium text-gray-900">S/.{total_compare_amount}</dd>
              </div>

              {
                  ...
                  <>
                    <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                        ...
                        <dd className="text-sm font-medium text-gray-900">S/.{total_after_coupon}</dd>
                    </div>
                    <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                        <dt className="text-base font-medium text-gray-900">Order Total</dt>
                        <dd className="text-base font-medium text-gray-900">S/.{total_amount}</dd>
                    </div>
                    </>
                        :
                    <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
